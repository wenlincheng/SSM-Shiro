...
CREATE TABLE `t_role_resource` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '角色资源关联 ID',
  `role_id` int(10) NOT NULL COMMENT '角色 id',
  `resource_id` int(10) NOT NULL COMMENT '资源 id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='角色资源关联表';

/*Data for the table `t_role_resource` */

insert  into `t_role_resource`(`id`,`role_id`,`resource_id`) values (1,1,1),(28,2,19),(29,2,23),(30,2,31),(32,2,33),(34,2,41),(37,2,71),(50,3,71),(51,3,23),(57,3,80),(58,3,72),(59,2,72),(60,2,80),(61,2,78),(62,3,24),(63,3,34);
...
CREATE TABLE `t_system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2670 DEFAULT CHARSET=utf8 COMMENT='系统日志';

/*Data for the table `t_system_log` */

insert  into `t_system_log`(`id`,`description`,`method`,`request_type`,`request_username`,`request_ip`,`request_uri`,`exception_code`,`exception_detail`,`params`,`create_date`) values (2669,'用户登录','com.wenlincheng.ssm.controller.LoginController.login()','POST','admin','0:0:0:0:0:0:0:1','/login/submit',NULL,NULL,'TUser [Hash = 1233527158, userId=null, userName=admin, userPassword=123456, userTrueName=null, user','2019-01-21 23:43:43');
